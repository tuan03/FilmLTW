...
<%@ include file="partical/header.jsp" %>
    <main id="page-main">
        <section class="series-list-section">
            ...
            <div class="series-list-box most-watched-in-week">
                <div class="section-title">
                    <div class="section-title-strong">
                        Top 10 phim được xem nhiều nhất trong 3 tháng trở lại đây
                    </div>
                </div>
            ...
            <!-- top newest uploaded series //:MARK -->
            <div class="series-list-box newest-uploaded">
                <div class="section-title">
                    <div class="section-title-strong">
                        Top 10 phim được tải lên mới nhất
                    </div>
                </div>
