                ...
                <div class="genres">
                	<c:forEach var="genre" items="${genres }">
                		<form action="genre/edit.htm?id=${genre.id }" method="post">
                		 <div class="genre">
                        <input class="editor" name="content" placeholder="Nhập thể loại..." type="text" value="${genre.name }"  />
                        <div class="actions">
                            <button type="submit" class="save-action" style="background-color: transparent;">
                ...
                <div class="search-series">
                    <div class="form-group">
                        <div class="input-wrapper">
                            ...
                            <input id="search-series-input" placeholder="Tìm phim theo tên phim..." name="series-name"
                                autocomplete="on">
                        </div>
                    </div>
